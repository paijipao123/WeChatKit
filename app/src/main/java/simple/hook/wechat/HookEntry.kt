...
class HookEntry : IXposedHookLoadPackage {
    ...
    companion object {
        ...
        val FEATURES: List<Feature> = listOf(
            ...
            simple.hook.wechat.features.chat.RoundAvatarFeature,
            simple.hook.wechat.features.chat.AvatarTimeFeature,
            AutoRedPacketFeature,
            AutoCollectTransferFeature,
            simple.hook.wechat.features.system.SignatureBypassFeature,
            simple.hook.wechat.features.system.TabletModeFeature,
        )
    }
    ...
    private fun loadFeatures(lpparam: XC_LoadPackage.LoadPackageParam) {
        ...
        simple.hook.wechat.core.SymbolResolver.detectWechatVersion()
        ...
        runCatching {
            simple.hook.wechat.core.SettingsInjector.hook(realLoader)
