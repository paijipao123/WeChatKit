...
import simple.hook.wechat.features.chat.AntiRecallFeature
import simple.hook.wechat.features.chat.HideAvatarFeature
import simple.hook.wechat.features.money.AutoCollectTransferFeature
import simple.hook.wechat.features.money.AutoRedPacketFeature
import simple.hook.wechat.features.moments.AntiMomentsDeleteFeature
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 请求存储权限（配置存于 /sdcard/WeChatSimple/）
        ...
        root.addView(card(
            ...
            listOf(
                ...
                SwitchItem("圆形头像",
                    "头像渲染为圆形（可调圆角）",
                    "feat_${simple.hook.wechat.features.chat.RoundAvatarFeature.key}",
                    simple.hook.wechat.features.chat.RoundAvatarFeature.defaultEnabled(),
                    params = listOf(
                ...
                SwitchItem("消息时间显示",
                    "消息发送时间（头像下方/消息下方）",
                    "feat_${simple.hook.wechat.features.chat.AvatarTimeFeature.key}",
                    simple.hook.wechat.features.chat.AvatarTimeFeature.defaultEnabled(),
                    params = listOf(
                ...
                SwitchItem("签名绕过",
                    ...
                    "feat_${simple.hook.wechat.features.system.SignatureBypassFeature.key}",
                    simple.hook.wechat.features.system.SignatureBypassFeature.defaultEnabled()),
                SwitchItem("平板模式",
                    "强制识别为平板：同机双开或两设备同号登录",
                    "feat_${simple.hook.wechat.features.system.TabletModeFeature.key}",
                    simple.hook.wechat.features.system.TabletModeFeature.defaultEnabled()),
            )
        ))
